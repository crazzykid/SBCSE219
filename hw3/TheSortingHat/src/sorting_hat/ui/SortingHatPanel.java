    ...
    public void renderStats(Graphics g)
    {
        ...
        if (game.getGUIDialogs().get(STATS_DIALOG_TYPE).getState().equals(SortingHatTileState.VISIBLE_STATE.toString()))
        {
           ...
           // as
            ...
            String perfectWins = props.getProperty(SortingHatPropertyType.TEXT_LABEL_STATS_PERFECT_WINS);
            String fastPerfectWins = props.getProperty(SortingHatPropertyType.TEXT_LABEL_STATS_FASTEST_PERFECT_WIN);
